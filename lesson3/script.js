...
for (let i = 0; i < 10; i++) {
    document.write(`<div><p>Block from task 1</p></div>`)
}
...
while (i < 20) {
    document.write(`<h1>Title "h1" from task 3</h1>`)
    i++
}
...
while (i2 < 20) {
    document.write(`<h1>Title "h1" from task 4 with ${i2} index</h1>`)
    i2++
}
//
...
document.write(`<h4>Users who have status "true"</h4>`)
...
document.write(`<h4>Users who have status "false"</h4>`)
...
document.write(`<h4>Users who are older than 30 years</h4>`)
...
document.write(`<h2>Task 8 Additional</h2>`)
...
document.write(`<h2>Task 9 Additional 2</h2>`)
...
for (let usersListElement of usersList) {
    document.write(`
                    <div class="user-block">
                        ...
                        <h3><a href="mailto:${usersListElement.email}">${usersListElement.email}</a> - <a href="tel:${usersListElement.phone}">${usersListElement.phone}</a></h3>
